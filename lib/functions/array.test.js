...
import { chain, chain_from_iterable, compress, compress_from_iterable, count, cycle, flatten, permutations, product, range, repeat, zip_longest, } from "./index.js";
describe("Array", function () {
    ...
    describe("compress_from_iterable", function () {
        const iterator = compress_from_iterable(["ABCDEF", "FGHIJK"], [1, 0, 1, 0, 1, 1]);
        it("should return the 1st iteration", function () {
